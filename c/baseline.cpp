...
//
// Implementation of Sablib_BaselineAisPLS() function.
//
const SABLIB_BASELINE_DATA_PTR Sablib_BaselineAisPLS(
...
)
{
	...
	auto result = sablib::BaselineAisPLS(yy, lambda, r, s, loop, eps);
